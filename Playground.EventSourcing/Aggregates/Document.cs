...
public record CandidateFileRevisionUploaded(Guid ProductId, string FileName, string InternalUniqueFileName, string ChangeLog, DateTimeOffset UploadedAt, string UploadedBy) : IDomainEvent;
public record CandidateFileRevisionApproved(Guid ProductId, string FileName, string InternalUniqueFileName, string ChangeLog, string ApprovalComment, DateTimeOffset ApprovedAt, string ApprovedBy) : IDomainEvent;
public record CandidateFileRevisionDeclined(Guid ProductId, string DeclinedComment, DateTimeOffset DeclinedAt, string DeclinedBy) : IDomainEvent;
...
public sealed record Product(
    ...
    IReadOnlyList<FileRevision> Revisions) : AggregateBase<Product>(Id)
{
    ...
    private Product Apply(CandidateFileRevisionUploaded _)
    {
    ...
    private Product Apply(CandidateFileRevisionApproved @event)
    {
    ...
    private Product Apply(CandidateFileRevisionDeclined _)
    {
